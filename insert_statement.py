...
df.columns = ["name", "barcode", "purchase_price", "selling_price", "commution","stock", "image_url"]
...
for _, row in df.iterrows():
    ...
    statement = f"INSERT INTO {table_name} (name, barcode, purchase_price, selling_price, commution, stock, image_url) VALUES {values};"
